...
abstract contract ERC20Charity is IERC20charity, ERC20, Ownable {
    ...
    * @dev Requirements:
     ...
     */
    function setSpecificDefaultAddress(address whitelistedAddr) external virtual{
    ...
    * @dev Requirements:
     ...
     */
    function setSpecificDefaultAddressAndRate(address whitelistedAddr , uint256 rate) external virtual{
    ...
    * @dev Requirements:
     ...
     * @param rate The personalised rate for donation.
     */
    function setSpecificRate(address whitelistedAddr , uint256 rate) external virtual onlyOwner{
        require(rate <= _feeDenominator(), "ERC20Charity: rate must be between 0 and _feeDenominator");
        require(rate >= _defaultRate(), "ERC20Charity: rate fee must exceed default rate");
        require(whitelistedRate[whitelistedAddr]!=0, "ERC20Charity: invalid whitelisted address");
    ...
    * The default rate specified in {whitelistedRate} will be applied.
     */
    function SpecificDefaultAddress() external virtual view returns (address) {
     ...
     */
    function charityInfo( address charityAddr) external view virtual returns (bool, uint256 rate) {
